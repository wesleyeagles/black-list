...
export type AccountManyWhereInput = {
  ...
  /** All values containing the given string. */
  login_contains?: InputMaybe<Scalars['String']>;
  /** All values ending with the given string. */
  login_ends_with?: InputMaybe<Scalars['String']>;
  /** All values that are contained in given list. */
  login_in?: InputMaybe<Array<InputMaybe<Scalars['String']>>>;
  /** Any other value that exists and is not equal to the given value. */
  login_not?: InputMaybe<Scalars['String']>;
  /** All values not containing the given string. */
  login_not_contains?: InputMaybe<Scalars['String']>;
  /** All values not ending with the given string */
  login_not_ends_with?: InputMaybe<Scalars['String']>;
  /** All values that are not contained in given list. */
  login_not_in?: InputMaybe<Array<InputMaybe<Scalars['String']>>>;
  /** All values not starting with the given string. */
  login_not_starts_with?: InputMaybe<Scalars['String']>;
  /** All values starting with the given string. */
  login_starts_with?: InputMaybe<Scalars['String']>;
...
export type MemberCreateInput = {
  cargo: Scalars['String'];
  clhds52em2wb701ukde1ma626?: InputMaybe<AccountCreateManyInlineInput>;
...
export type MemberManyWhereInput = {
  ...
  /** All values containing the given string. */
  cargo_contains?: InputMaybe<Scalars['String']>;
  /** All values ending with the given string. */
  cargo_ends_with?: InputMaybe<Scalars['String']>;
  /** All values that are contained in given list. */
  cargo_in?: InputMaybe<Array<InputMaybe<Scalars['String']>>>;
  /** Any other value that exists and is not equal to the given value. */
  cargo_not?: InputMaybe<Scalars['String']>;
  /** All values not containing the given string. */
  cargo_not_contains?: InputMaybe<Scalars['String']>;
  /** All values not ending with the given string */
  cargo_not_ends_with?: InputMaybe<Scalars['String']>;
  /** All values that are not contained in given list. */
  cargo_not_in?: InputMaybe<Array<InputMaybe<Scalars['String']>>>;
  /** All values not starting with the given string. */
  cargo_not_starts_with?: InputMaybe<Scalars['String']>;
  /** All values starting with the given string. */
  cargo_starts_with?: InputMaybe<Scalars['String']>;
  cpt?: InputMaybe<Scalars['Float']>;
  /** All values greater than the given value. */
  cpt_gt?: InputMaybe<Scalars['Float']>;
  /** All values greater than or equal the given value. */
  cpt_gte?: InputMaybe<Scalars['Float']>;
  /** All values that are contained in given list. */
  cpt_in?: InputMaybe<Array<InputMaybe<Scalars['Float']>>>;
  /** All values less than the given value. */
  cpt_lt?: InputMaybe<Scalars['Float']>;
  /** All values less than or equal the given value. */
  cpt_lte?: InputMaybe<Scalars['Float']>;
  /** Any other value that exists and is not equal to the given value. */
  cpt_not?: InputMaybe<Scalars['Float']>;
  /** All values that are not contained in given list. */
  cpt_not_in?: InputMaybe<Array<InputMaybe<Scalars['Float']>>>;
  createdAt?: InputMaybe<Scalars['DateTime']>;
  /** All values greater than the given value. */
  createdAt_gt?: InputMaybe<Scalars['DateTime']>;
  /** All values greater than or equal the given value. */
  ...
  /** All values greater than the given value. */
  idClass_gt?: InputMaybe<Scalars['Int']>;
  /** All values greater than or equal the given value. */
  idClass_gte?: InputMaybe<Scalars['Int']>;
  /** All values that are contained in given list. */
  idClass_in?: InputMaybe<Array<InputMaybe<Scalars['Int']>>>;
  /** All values less than the given value. */
  idClass_lt?: InputMaybe<Scalars['Int']>;
  /** All values less than or equal the given value. */
  idClass_lte?: InputMaybe<Scalars['Int']>;
  /** Any other value that exists and is not equal to the given value. */
  idClass_not?: InputMaybe<Scalars['Int']>;
  /** All values that are not contained in given list. */
  idClass_not_in?: InputMaybe<Array<InputMaybe<Scalars['Int']>>>;
  idRace?: InputMaybe<Scalars['Int']>;
  /** All values greater than the given value. */
  idRace_gt?: InputMaybe<Scalars['Int']>;
  /** All values greater than or equal the given value. */
  idRace_gte?: InputMaybe<Scalars['Int']>;
  /** All values that are contained in given list. */
  idRace_in?: InputMaybe<Array<InputMaybe<Scalars['Int']>>>;
  /** All values less than the given value. */
  idRace_lt?: InputMaybe<Scalars['Int']>;
  /** All values less than or equal the given value. */
  idRace_lte?: InputMaybe<Scalars['Int']>;
  /** Any other value that exists and is not equal to the given value. */
  idRace_not?: InputMaybe<Scalars['Int']>;
  /** All values that are not contained in given list. */
  idRace_not_in?: InputMaybe<Array<InputMaybe<Scalars['Int']>>>;
  /** All values containing the given string. */
  id_contains?: InputMaybe<Scalars['ID']>;
  /** All values ending with the given string. */
  id_ends_with?: InputMaybe<Scalars['ID']>;
  ...
  /** Any other value that exists and is not equal to the given value. */
  playOnOpen_not?: InputMaybe<Scalars['Boolean']>;
  pontos?: InputMaybe<Scalars['Float']>;
  /** All values greater than the given value. */
  pontos_gt?: InputMaybe<Scalars['Float']>;
  /** All values greater than or equal the given value. */
  pontos_gte?: InputMaybe<Scalars['Float']>;
  /** All values that are contained in given list. */
  pontos_in?: InputMaybe<Array<InputMaybe<Scalars['Float']>>>;
  /** All values less than the given value. */
  pontos_lt?: InputMaybe<Scalars['Float']>;
  /** All values less than or equal the given value. */
  pontos_lte?: InputMaybe<Scalars['Float']>;
  /** Any other value that exists and is not equal to the given value. */
  pontos_not?: InputMaybe<Scalars['Float']>;
  /** All values that are not contained in given list. */
  pontos_not_in?: InputMaybe<Array<InputMaybe<Scalars['Float']>>>;
  publishedAt?: InputMaybe<Scalars['DateTime']>;
  /** All values greater than the given value. */
  publishedAt_gt?: InputMaybe<Scalars['DateTime']>;
  /** All values greater than or equal the given value. */
...
export enum MemberOrderByInput {
  ...
  CreatedAtAsc = 'createdAt_ASC',
  CreatedAtDesc = 'createdAt_DESC',
  IdClassAsc = 'idClass_ASC',
  IdClassDesc = 'idClass_DESC',
  IdRaceAsc = 'idRace_ASC',
  IdRaceDesc = 'idRace_DESC',
  IdAsc = 'id_ASC',
  IdDesc = 'id_DESC',
  LevelAsc = 'level_ASC',
  LevelDesc = 'level_DESC',
  MemberStatusAsc = 'memberStatus_ASC',
  MemberStatusDesc = 'memberStatus_DESC',
  NicknameAsc = 'nickname_ASC',
  NicknameDesc = 'nickname_DESC',
  PlayOnOpenAsc = 'playOnOpen_ASC',
  PlayOnOpenDesc = 'playOnOpen_DESC',
  PontosAsc = 'pontos_ASC',
  PontosDesc = 'pontos_DESC',
  PublishedAtAsc = 'publishedAt_ASC',
  PublishedAtDesc = 'publishedAt_DESC',
  UpdatedAtAsc = 'updatedAt_ASC',
  UpdatedAtDesc = 'updatedAt_DESC'
...
export type MemberUpdateInput = {
  cargo?: InputMaybe<Scalars['String']>;
  clhds52em2wb701ukde1ma626?: InputMaybe<AccountUpdateManyInlineInput>;
  cpt?: InputMaybe<Scalars['Float']>;
  idClass?: InputMaybe<Scalars['Int']>;
  idRace?: InputMaybe<Scalars['Int']>;
  level?: InputMaybe<Scalars['Int']>;
...
export type CreateMemberMutation = { __typename?: 'Mutation', updateAccount?: { __typename?: 'Account', id: string } | null, publishMember?: { __typename?: 'Member', id: string } | null };
...
export type EditMemberMutation = { __typename?: 'Mutation', updateMember?: { __typename?: 'Member', id: string } | null, publishMember?: { __typename?: 'Member', nickname: string } | null };
...
export type GetMemberByNicknameQuery = { __typename?: 'Query', member?: { __typename?: 'Member', id: string, idRace: number, level: number, nickname: string, playOnOpen: boolean, pontos?: number | null, idClass: number, memberStatus: boolean, cpt?: number | null, cargo: string } | null };
...
export const CreateMemberDocument = gql`
  ...
  updateAccount(
    where: {id: $id}
    data: {members: {create: {nickname: $nickname, idClass: $idClass, playOnOpen: $playOnOpen, cargo: "Membro", cpt: $cpt, level: $level, memberStatus: $memberStatus, idRace: $idRace, clhds52em2wb701ukde1ma626: {connect: {id: $id}}}}}
  ) {
    id
  }
 ...
 *      playOnOpen: // value for 'playOnOpen'
...
/**
 * __useGetMemberByNicknameQuery__
 *
 * To run a query within a React component, call `useGetMemberByNicknameQuery` and pass it any options that fit your needs.
 * When your component renders, `useGetMemberByNicknameQuery` returns an object from Apollo Client that contains loading, error, and data properties
 * you can use to render your UI.
 *
 * @param baseOptions options that will be passed into the query, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options;
 *
 * @example
 * const { data, loading, error } = useGetMemberByNicknameQuery({
 *   variables: {
 *      nickname: // value for 'nickname'
 *   },
 * });
 */
export function useGetMemberByNicknameQuery(baseOptions: Apollo.QueryHookOptions<GetMemberByNicknameQuery, GetMemberByNicknameQueryVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useQuery<GetMemberByNicknameQuery, GetMemberByNicknameQueryVariables>(GetMemberByNicknameDocument, options);
      }
export function useGetMemberByNicknameLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<GetMemberByNicknameQuery, GetMemberByNicknameQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useLazyQuery<GetMemberByNicknameQuery, GetMemberByNicknameQueryVariables>(GetMemberByNicknameDocument, options);
        }
export type GetMemberByNicknameQueryHookResult = ReturnType<typeof useGetMemberByNicknameQuery>;
export type GetMemberByNicknameLazyQueryHookResult = ReturnType<typeof useGetMemberByNicknameLazyQuery>;
